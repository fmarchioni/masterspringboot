...
*/}}
{{- define "helm-chart-demo.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "helm-chart-demo.fullname" .) .Values.serviceAccount.name }}
{{- else }}
